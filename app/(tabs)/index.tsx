...
// Mock fallback videos - diverse Sora AI-generated content
const FALLBACK_VIDEOS: Video[] = [
  ...
  {
    id: '3',
    name: 'Cosmic Space Journey',
    url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663582603941/uVFjRxyGEvVYafOu.mp4',
    creator: 'StarDancer',
    creatorHandle: '@StarDancer',
  ...
  },
  {
    ...
    url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663582603941/ZIHqcEAjIsUDSuBR.mp4',
    creator: 'UrbanFlow',
    creatorHandle: '@UrbanFlow',
    title: '🏙️ Urban Street Style',
    likes: 5600,
    comments: 289,
    liked: false,
  },
  {
    ...
    url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663582603941/uVFjRxyGEvVYafOu.mp4',
    creator: 'MysticWood',
    creatorHandle: '@MysticWood',
    title: '🌲 Enchanted Forest Magic',
    likes: 9100,
    comments: 634,
    liked: false,
  },
  {
    id: '6',
    name: 'Retro Synthwave Nights',
    url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663582603941/ZIHqcEAjIsUDSuBR.mp4',
    creator: 'RetroWave',
    creatorHandle: '@RetroWave',
    title: '🎹 Retro Synthwave Nights',
    likes: 7800,
    comments: 521,
    liked: false,
  },
  {
    id: '7',
    name: 'Desert Sunset Vibes',
    url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663582603941/uVFjRxyGEvVYafOu.mp4',
    creator: 'DesertSun',
    creatorHandle: '@DesertSun',
    title: '🌅 Desert Sunset Vibes',
    likes: 6400,
    comments: 378,
    liked: false,
  },
  ...
  {
    id: '9',
    name: 'Futuristic City Lights',
    url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663582603941/uVFjRxyGEvVYafOu.mp4',
    creator: 'FutureVision',
    creatorHandle: '@FutureVision',
    title: '🚀 Futuristic City Lights',
    likes: 9500,
    comments: 712,
    liked: false,
  },
  {
    id: '10',
    name: 'Vintage Hollywood Glam',
    url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663582603941/ZIHqcEAjIsUDSuBR.mp4',
    creator: 'ClassicGlam',
    creatorHandle: '@ClassicGlam',
